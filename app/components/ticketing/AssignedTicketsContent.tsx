...
// Card-style layout matching functionality cards
// ============================================
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className={`text-2xl font-black ${charColors.text}`}>Assigned Tickets</h1>
                  <p className={`text-sm ${colors.textMuted}`}>
          ...
          {filteredTickets.map((ticket) => {
            ...
            return (
              <button
                ...
                className={`group relative overflow-hidden rounded-2xl border-2 backdrop-blur-sm text-left transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br ${statusChar.bg} ${statusChar.border} ${colors.shadowCard} hover:${colors.shadowHover}`}
              >
                <div className={`absolute inset-0 ${colors.paperTexture} opacity-[0.03]`}></div>
                <div 
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
