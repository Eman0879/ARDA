// ============================================
// app/components/depthead-project/EditModal.tsx
// ============================================

import { X, Save, Calendar, Users, AlertCircle, Upload } from 'lucide-react';
      ...
      <div className={`relative rounded-2xl p-8 w-full max-w-3xl max-h-[90vh] overflow-y-auto ${colors.shadowDropdown} backdrop-blur-md border ${colors.borderStrong}`}>
        ...
        <div className={`relative bg-gradient-to-br ${colors.cardBg} rounded-2xl p-8 -m-8`}>
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className={`text-sm mt-2 ${colors.textSecondary}`}>
                Update the details of this {itemType.toLowerCase()}
              </p>
            </div>
            <button 
              onClick={onClose} 
          ...
          <div className={`flex gap-4 mt-8 pt-6 border-t ${colors.border}`}>
            ...
            <button
              onClick={onUpdate}
              className={`group relative flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-xl font-semibold transition-all overflow-hidden ${colors.buttonPrimary} ${colors.buttonPrimaryText} ${colors.buttonPrimaryHover} ${colors.shadowCard} hover:${colors.shadowHover}`}
            >
              {/* Paper Texture Layer */}
              ...
              <Save className="w-4 h-4 relative z-10 group-hover:rotate-12 group-hover:translate-x-1 transition-all duration-300" />
              <span className="relative z-10">Update {itemType}</span>
            </button>
          </div>
        </div>
      </div>
