// app/(Dashboard)/employee/components/EmployeeSidebar.tsx
'use client';

import React, { useState } from 'react';
import { 
  Home, FileText, Building2, Clock, ChevronRight,
  Settings, BarChart3, Activity, Calendar, Users, ListChecks, TicketIcon, Megaphone
} from 'lucide-react';
...
export default function EmployeeSidebar({ activeItem, onItemClick, department, isOpen, onClose }: EmployeeSidebarProps) {
