// app/(Dashboard)/hr-head/components/HRHeadSidebar.tsx
'use client';
...
export default function HRHeadSidebar({ activeItem, onItemClick, isOpen, onClose }: HRHeadSidebarProps) {
