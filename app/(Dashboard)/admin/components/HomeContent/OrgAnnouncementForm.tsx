// app/(Dashboard)/hr-head/components/HomeContent/OrgAnnouncementForm.tsx
'use client';
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h4 className="text-lg font-black text-white">New Organization Announcement</h4>
        <button
          onClick={onCancel}
      ...
      <div className="space-y-4">
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-black/40 backdrop-blur-sm border-2 rounded-xl text-white placeholder-white/50 focus:outline-none font-bold transition-all ${
              errors.title 
                ...
                : 'border-white/30 focus:border-[#FF0000]'
            }`}
          />
          {errors.title && (
            <div className="flex items-center gap-2 mt-2 text-[#FFD700] text-sm font-semibold">
        ...
        {/* Attachments */}
        <div>
          <label className="flex items-center gap-2 px-4 py-3 bg-black/40 hover:bg-black/60 border-2 border-white/30 hover:border-[#FF0000] rounded-xl text-white font-bold cursor-pointer transition-all w-fit">
        ...
        <div className="relative">
          <label className="block text-sm font-bold text-white mb-3 flex items-center gap-2">
            <Calendar className="h-5 w-5" style={{ color: selectedColor }} />
          ...
          <div className="flex gap-3 items-center">
            <button
              ...
              className="flex-1 h-14 px-5 py-3 bg-black/60 backdrop-blur-sm border-2 rounded-xl text-white font-semibold text-left transition-all hover:opacity-80 focus:outline-none"
              style={{
                borderColor: selectedColor,
                boxShadow: `0 0 15px ${selectedColor}50`
              }}
            >
            ...
            {expirationDate && (
              <button
                ...
                className="h-14 px-5 py-3 bg-gray-700/50 hover:bg-gray-600/50 border-2 border-gray-500/60 rounded-xl text-white font-bold transition-all flex items-center gap-2"
