// app/(Dashboard)/hr-employee/dashboard/page.tsx
'use client';

import React, { useState, useEffect } from 'react';
import { useRouter } from 'next/navigation';
import { useTheme } from '@/app/context/ThemeContext';
import EmployeeSidebar from '../components/HREmployeeSidebar';
import EmployeeHeader from '../components/HREmployeeHeader';
import HomeContent from '../components/HREmployeeHomeContent';
...
export default function EmployeeDashboard() {
  ...
  const renderContent = () => {
    switch (activeSection) {
      case 'home':
        return <HomeContent department={user.department} onSectionChange={setActiveSection} />;
