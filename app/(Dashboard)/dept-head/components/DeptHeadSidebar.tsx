// app/(Dashboard)/dept-head/components/DeptHeadSidebar.tsx
'use client';
...
interface DeptHeadSidebarProps {
  activeItem: string;
...
export default function DeptHeadSidebar({ activeItem, onItemClick, department, isOpen, onClose }: DeptHeadSidebarProps) {
